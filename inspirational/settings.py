...
# Choose primary auth backend via env if needed
# Examples:
#   AUTH_BACKEND_PRIMARY=accounts.backends.EmailOrUsernameModelBackend
#   AUTH_BACKEND_PRIMARY=accounts.authentication.EmailAuthBackend
AUTH_BACKEND_PRIMARY = env(
    "AUTH_BACKEND_PRIMARY",
    default="accounts.backends.EmailOrUsernameModelBackend",
)
...
if not DEBUG:
    ...
    X_FRAME_OPTIONS = "SAMEORIGIN"  # was "DENY"
...
SITE_URL = env(
    "SITE_URL",
    default=("http://localhost:8000" if DEBUG else "https://inspirationalguidance.com"),
)
