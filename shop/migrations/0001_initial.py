    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.FileField(blank=True, help_text='Upload a PDF or ZIP file. Use ZIP for bundles.', null=True, storage=inspirational.storage.SecureFileStorage(), upload_to='products/files/')),
                ...
                ('video_file', models.FileField(blank=True, help_text='Upload a short MP4 file to display as product video', null=True, storage=inspirational.storage.PublicMediaStorage(), upload_to='products/videos/')),
